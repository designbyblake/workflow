...
casper.test.begin('Fishbowl Technology', function(test) {
    phantomcss.init({
    ...
    casper.start(spooky.root + 'our-technology/')
        ...
        .scrollToBottom()
        .then(function() {
            phantomcss.screenshot('.list-container', 'List Container Desktop');
        })
        .then(function() {
            casper.viewport(spooky.mediumW, spooky.mediumH);
            phantomcss.screenshot('.list-container', 'List Container Tablet');

        })
        .then(function() {
            casper.viewport(spooky.smallW, spooky.smallH);
            phantomcss.screenshot('.list-container', 'List Container Mobile');
        })
